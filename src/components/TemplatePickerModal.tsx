...
export const TemplatePickerModal: React.FC<TemplatePickerModalProps> = ({ isOpen, onClose, onSelect }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        ref={dialogRef}
        className="relative bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-2xl flex flex-col max-h-[90vh]"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100 flex-shrink-0">
          <div>
            <h2 id="template-picker-title" className="text-lg font-semibold text-slate-900">New Document</h2>
            <p id="template-picker-description" className="text-sm text-slate-500 mt-0.5">Choose a template to get started</p>
          </div>
          <button
            onClick={onClose}
