      ...
      <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-medium text-slate-900">Interactive Features (HTML only)</h3>
        ...
        <div className="px-6 py-4 border-t border-slate-100 flex items-center justify-end gap-3 bg-slate-50">
          ...
          {onExportMarkdown && (
            <button
              onClick={() => {
                onExportMarkdown(fileName.trim() || 'Untitled Guide');
                onClose();
              }}
              className="px-4 py-2 text-sm font-medium text-slate-700 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors flex items-center gap-2 border border-slate-200"
            >
              <FileDown size={15} />
              .md
            </button>
